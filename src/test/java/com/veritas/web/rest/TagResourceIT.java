...
import static com.veritas.domain.TagAsserts.*;
...
class TagResourceIT {
    ...
    public static Tag createEntity(EntityManager em) {
        Tag tag = new Tag().name(DEFAULT_NAME).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT).isActive(DEFAULT_IS_ACTIVE);
        return tag;
    }
    ...
    public static Tag createUpdatedEntity(EntityManager em) {
        Tag tag = new Tag().name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).isActive(UPDATED_IS_ACTIVE);
        return tag;
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).isActive(UPDATED_IS_ACTIVE);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).isActive(UPDATED_IS_ACTIVE);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT).isActive(UPDATED_IS_ACTIVE);
