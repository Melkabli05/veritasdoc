...
import { sampleWithRequiredData } from '../file-version.test-samples';
...
describe('FileVersion Management Component', () => {
  let comp: FileVersionComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, FileVersionComponent],
      providers: [
        {
      ...
      .overrideTemplate(FileVersionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fileVersions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fileVersionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFileVersionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFileVersionIdentifier).toHaveBeenCalledWith(entity);
